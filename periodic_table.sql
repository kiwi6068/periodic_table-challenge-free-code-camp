...
--
-- Name: elements unique_ele; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_ele UNIQUE (name, symbol);


--
-- Name: properties properties_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_fkey FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
